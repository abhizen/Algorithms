 ...
 */
public class CourseScheduleTuned {
    public boolean canFinish(int numCourses, int[][] prerequisites) {
        ...
        for(int i=0;i<prerequisites.length;i++){
            addFriend(map,prerequisites[i][0],prerequisites[i][1]);
        }
    ...
    private void addFriend(Map<Integer,List<Integer>> map,Integer node,Integer friend){
        List<Integer> friends = map.get(node);

        if(friends!=null){
            if(map.get(friend)==null){
                map.put(friend,new ArrayList<Integer>());
            }
            friends.add(node);
    ...
    private boolean dfs(Map<Integer,List<Integer>> map,int[] visited,Integer node){
        List<Integer> friends = null;
    ...
    public static void main(String[] args) {
        CourseScheduleTuned instance = new CourseScheduleTuned();
        int[][] nums =
        ...
        if(instance.canFinish(500,nums)){
